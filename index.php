...
<body>
	...
	/* Inclusion du menu selon le mode d'identification choisi*/
	if(isset($_GET['page']) && $_GET['page'] !== 'identificationfede' && $_GET['page'] !== 'accueil')  {
		if($_SESSION['login'] == "Fédération"){
		/* Inclusion du menu */
		include('static/menufede.php');
	} }  

	if(isset($_GET['page']) && $_GET['page'] !== 'identification' && $_GET['page'] !== 'accueil') {
			if($_SESSION['login'] == "Ecole") {
